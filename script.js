...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const experience = [
        ...
        },
        {
            ...
            description: `
                <ul class="experience-list">
                    <li>Developed OCR system (Optical Character Recognition) for Khmer language using PyTesseract, OpenCV, and a CNN-GRU architecture.</li>
    ...
    // Certifications Data (Your original content)
    ...
    // Skills Data (Your original content)
    const skills = [
    ...
    // Projects Data (Your original content with proper IDs)
    const projects = [
        {
            id: 'academic-chatbot',
        ...
        {
            id: 'Finetune-Text-to-Speech',  // Important: This is the anchor target
            title: 'Finetune Text to Speech',
            description: `
            <ul>
                <li>Fine-tuned SpeechT5 model for multilingual speech generation.</li>
                <li>Processed VoxPopuli dataset (10-15 hours of audio).</li>
                <li>Implemented text normalization, tokenization, and feature extraction.</li>
            </ul>
            `,
    ...
    // Education Data (Your original content)
    const education = [
        {
    ...
    //         // Only show certificate link for Institute of Technology of Cambodia
    //         const certLink = edu.institution === "Institute of Technology of Cambodia" && edu.certificateLink 
    ...
    function populateProjects() {
        ...
        projects.forEach(project => {
            ...
            div.id = project.id;  // This creates the anchor target
            div.innerHTML = `
                <h3>${project.title}</h3>
    ...
    // Enhanced Anchor Link Handling (From working reference code)
